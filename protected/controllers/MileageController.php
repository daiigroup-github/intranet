...
// 		));
		...
		if(isset($_GET['Mileage']))
		{
			...
			$models = Mileage::mileageDateWithEmployeeIdAndDateRange($_GET['Mileage']['employeeId'], $_GET['Mileage']['startDate'], $_GET['Mileage']['endDate']);
		}
		else
		{
			$model->startDate = date('Y-m') . '-01';
			$model->endDate = Controller::lastDateOfThisMonth();
			$models = null;
		}
