...
class MigrateController extends MasterFitFastModuleController
{
                    ...
                    foreach ($fitandfasts as $fitandfast) {
                        ...
                        if ($fitfast->save()) {
                            ...
                            for ($i = 0; $i < 12; $i++) {
                                ...
                                if (!isset($fitandfast->{$targetArray[$i]}) || empty($fitandfast->{$targetArray[$i]}) || $fitandfast->{$targetArray[$i]} == '')
                                    continue;
