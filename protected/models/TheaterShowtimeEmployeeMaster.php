 ...
 *
 * The followings are the available columns in table 'theater_showtime_employee':
 * @property string $id
 ...
 */
class TheaterShowtimeEmployeeMaster extends MasterCActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('theaterShowTimeId, employeeId', 'required'),
			array('status', 'numerical', 'integerOnly'=>true),
			array('reserveCode, theaterShowTimeId, employeeId', 'length', 'max'=>20),
			array('cancelRemark, createDateTime, updateDateTime', 'safe'),
			...
			array('id, reserveCode, theaterShowTimeId, employeeId, cancelRemark, status, createDateTime, updateDateTime', 'safe', 'on'=>'search'),
		);
	}
	...
	public function attributeLabels()
	{
		return array(
			...
			'theaterShowTimeId' => 'Theater Show Time',
			'employeeId' => 'Employee',
	...
	public function search()
	{
		...
		$criteria->compare('LOWER(theaterShowTimeId)',strtolower($this->searchText),true, 'OR');
		$criteria->compare('LOWER(employeeId)',strtolower($this->searchText),true, 'OR');
		$criteria->compare('LOWER(cancelRemark)',strtolower($this->searchText),true, 'OR');
	 ...
	 * @return TheaterShowtimeEmployeeMaster the static model class
	 */
