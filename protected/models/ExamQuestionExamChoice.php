 ...
 *
 * The followings are the available columns in table 'exam_question_exam_choice':
 * @property string $id
 * @property integer $status
 * @property string $examQuestionId
 * @property string $examChoiceId
 */
class ExamQuestionExamChoice extends CActiveRecord
{

	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return ExamQuestionExamChoice the static model class
	 */
