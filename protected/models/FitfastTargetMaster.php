 ...
 */
class FitfastTargetMaster extends MasterCActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array('employeeId, fitfastId, parentId', 'length', 'max'=>10),
			...
			array('fitfastTargetId, status, createDateTime, updateDateTime, employeeId, fitfastId, month, target, file, grade, parentId', 'safe', 'on'=>'search'),
		);
	}
