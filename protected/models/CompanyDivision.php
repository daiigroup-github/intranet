 ...
 *
 * The followings are the available columns in table 'company_division':
 * @property integer $id
 * @property integer $status
 * @property integer $companyDivisionId
 * @property string $description
 */
class CompanyDivision extends CActiveRecord
{

	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return CompanyDivision the static model class
	 */
	...
	public function rules()
	{
		...
		return array(
			array(
				'companyDivisionIdId, description',
				'required'),
			array(
