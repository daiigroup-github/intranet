 ...
 *
 * The followings are the available columns in table 'theater_showtime':
 ...
 */
class TheaterShowtimeMaster extends MasterCActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array(
				'theaterId, theaterMovieId, showDate',
				'required'),
			array(
				'status',
				'numerical',
			...
			array(
				'theaterShowtimeId, theaterId, theaterMovieId, showDate, status, createDateTime, updateDateTime',
				'safe',
				'on'=>'search'),
		);
	}
	...
	{
		return array(
			'theaterShowtimeId'=>'Theater Showtime',
			'theaterId'=>'Theater',
	...
	public function search()
	{
		...
		$criteria->compare('LOWER(theaterMovieId)', strtolower($this->searchText), true, 'OR');
	 ...
	 * @return TheaterShowtimeMaster the static model class
	 */
