 ...
 *
 * The followings are the available columns in table 'memo_to':
 * @property string $id
 ...
 */
class MemoTo extends CActiveRecord
{

	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return MemoTo the static model class
	 */
	...
	public function rules()
	{
		...
		return array(
			array(
				'memoId, employeeId, status, createDateTime',
				'required'),
			array(
				'status',
				'numerical',
