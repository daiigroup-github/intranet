...
class TheaterMovieMaster extends MasterCActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array(
				'theaterMovieId, theaterCategoryId, title, description, length, url, image, screenshotImage, status, createDateTime, updateDateTime',
				'safe',
				'on'=>'search'),
		);
	}
