...
$this->menu=array(
	...
	array('label'=>'View ElearningExamQuestion', 'url'=>array('view', 'id'=>$model->questionId)),
...
<?php echo $this->renderPartial('_form', array('model'=>$model, 'choiceModels'=>$choiceModels)); ?>