...
$this->menu=array(
	...
	array('label'=>'Update ElearningExamQuestion', 'url'=>array('update', 'id'=>$model->questionId)),
	array('label'=>'Delete ElearningExamQuestion', 'url'=>'#', 'linkOptions'=>array('submit'=>array('delete','id'=>$model->questionId),'confirm'=>'Are you sure you want to delete this item?')),
