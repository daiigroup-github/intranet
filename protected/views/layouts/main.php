...
<head>
    ...
    <?php //echo Yii::app()->request->baseUrl; ?><!--/js/jquery/jquery.js"></script>-->
    <!--		<script type="text/javascript" src="-->
    <?php //echo Yii::app()->request->baseUrl; ?><!--/js/jquery/jquery.tools.min.js"></script>-->
    <!--		<script type="text/javascript" src="-->
    <?php //echo Yii::app()->request->baseUrl; ?><!--/css/bootstrap/js/bootstrap.js"></script>-->

    <!-- Bootstrap-->
    <!--		<link rel="stylesheet" type="text/css" href="-->
    <?php //echo Yii::app()->request->baseUrl; ?><!--/css/bootstrap/css/bootstrap.css" />-->
    <style>
        body {
            padding-top: 50px;
        }
                ...
                <div class="nav-collapse">
                        ...
                        <ul class="nav">
                            ...
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li><a href="<?php echo Yii::app()->createUrl("application/jobInterview") ?>">นัดสัมภาษณ์</a>
                                    </li>
                                    <li>
                                        <a href="<?php echo Yii::app()->createUrl("application/interview") ?>">ประเมิณ</a>
                                    </li>
                                    <li><a href="<?php echo Yii::app()->createUrl("application/InterviewToCeo") ?>">นัดให้นายสัมภาษณ์</a>
                                    </li>
                                    <li><a href="<?php echo Yii::app()->createUrl("application/ceo") ?>">นายสัมภาษณ์</a>
                                    </li>
                                    <li>
                                        <a href="<?php echo Yii::app()->createUrl("application/accept") ?>">รับพนักงาน</a>
                                    </li>
                                </ul>
                            </li>
                        </ul>
                    ...
                    if (Yii::app()->user->name == "npr" || Yii::app()->user->name == "psd" || Yii::app()->user->name == "kpu") {
                        ...
                        <ul class="nav">
                            ...
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    <li><a href="<?php echo Yii::app()->createUrl('/qtechProject'); ?>">Qtech
                                            Projects</a></li>
                                </ul>
                            </li>
                            ...
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li>
                                        <a href="<?php echo Yii::app()->createUrl('/documentType/'); ?>">ประเภทเอกสาร</a>
                                    </li>
                                    <li><a href="<?php echo Yii::app()->createUrl('/documentTemplateField/'); ?>">ฟิลด์ของเอกสาร</a>
                                    </li>
                                    <li><a href="<?php echo Yii::app()->createUrl('/documentControlType/'); ?>">document
                                            Control Type</a></li>
                                    <li><a href="<?php echo Yii::app()->createUrl('/documentControlData/'); ?>">document
                                            Control Data</a></li>
                                    <li><a href="<?php echo Yii::app()->createUrl('/workflowGroup/'); ?>">กลุ่มของ
                                            Workflow</a></li>
                                    <li><a href="<?php echo Yii::app()->createUrl('/workflow/'); ?>">Workflow</a></li>
                                    <li><a href="<?php echo Yii::app()->createUrl('/workflowStatus/'); ?>">สถานะ
                                            Workflow</a></li>
                                </ul>
                            </li>
                            ...
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    <li><a href="<?php echo Yii::app()->createUrl('/document/admin'); ?>">การจัดการ
                                            เอกสาร</a></li>
                                    <li><a href="<?php echo Yii::app()->createUrl('/noticeType/admin'); ?>">การจัดการ
                                            ประเภท ประกาศ</a></li>
                    ...
                    <ul class="nav">
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li><a href="<?php echo Yii::app()->createUrl('theater/reserve/myReservedList'); ?>">รายการจองดูหนังของฉัน</a>
                                </li>
                                ...
                                if (Yii::app()->user->name == "npr" || Yii::app()->user->name == "psd" || Yii::app()->user->name == "kpu" || Yii::app()->user->name == "kbw" || Yii::app()->user->name == "ssd") {
                                    ?>
                                    <li><a href="<?php echo Yii::app()->createUrl('theater/theater'); ?>">การจัดการ
                                            โรงหนัง</a></li>
                                    <li><a href="<?php echo Yii::app()->createUrl('/theater/theaterCategory'); ?>">การจัดการหมวดหมู่หนัง</a>
                                    </li>
                                    <li><a href="<?php echo Yii::app()->createUrl('/theater/theaterMovie'); ?>">การจัดการหนัง
                                            และรอบฉาย</a></li>
                                <?php } ?>
                            </ul>
                        </li>
                    ...
                    <ul class="nav pull-right">
                        <li class="dropdown">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="icon-user icon-white"></i><?php echo (!Yii::app()->user->isGuest) ? strtoupper(Yii::app()->user->name) : ''; //CHtml::link('เข้าสู่ระบบ', Yii::app()->createUrl('/site/login'));                                                                   ?>
                                <b class="caret"></b></a>
                            <ul class="dropdown-menu">
                                <li><a href="<?php echo Yii::app()->createUrl('/employee/' . Yii::app()->user->id); ?>"><i class="icon-user"></i>ข้อมูลส่วนตัว</a>
                                </li>
                                <li>
                                    <a href="<?php echo Yii::app()->createUrl('/employee/changePassword/' . Yii::app()->user->id); ?>"><i class="icon-key"></i>เปลี่ยนรหัสผ่าน</a>
                                </li>
                                <li>
                                    <a href="<?php echo Yii::app()->createUrl('/leaveReport/leaveReport'); ?>"><i class="icon-list"></i>รายการใบลา</a>
                                </li>
                                <li>
                                    <a href="<?php echo Yii::app()->createUrl('/document/viewFixtime/' . Yii::app()->user->id); ?>"><i class="icon-list"></i>รายการใบแก้ไขเวลา</a>
                                </li>
                                <li class="divider"></li>
                                <li>
                                    <a href="<?php echo Yii::app()->createUrl('/site/logout/'); ?>"><i class="icon-signout"></i>ออกจากระบบ</a>
                                </li>
                            </ul>
                        </li>
                    </ul>
