    ...
    <div class="span3">
        <div class="well sidebar-nav">
            <ul class="nav nav-list">
                ...
                <?php
                if (Yii::app()->user->name == "npr" || Yii::app()->user->name == "psd" || Yii::app()->user->name == "kpu" || Yii::app()->user->name == "ssd" || Yii::app()->user->name == "psa" || Yii::app()->user->name == "ptr") {
                    ?>
...
//if(Yii::app()->user->name == "npr" || Yii::app()->user->name == "psd" || Yii::app()->user->name == "kpu"){
                ...
                <?php
                if (Yii::app()->user->name == "npr" || Yii::app()->user->name == "psd" || Yii::app()->user->name == "kpu" || strtolower(Yii::app()->user->name) == "ptr" || Yii::app()->user->name == "blk") {
                    ?>
